          ...
          <div className="flex items-center gap-4">
            ...
            {isSignInOpen && (
              <div className="fixed top-0 left-0 w-full h-full bg-black bg-opacity-50 flex items-center justify-center z-50">
                <div
                  ref={signInRef}
                  className="relative mx-auto w-full max-w-md overflow-hidden rounded-lg px-6 pb-8 pt-12 text-center bg-dark_grey bg-opacity-90 backdrop-blur-md sm:px-8"
                >
                  <button
                    onClick={() => {
                      setIsSignInOpen(false);
            ...
            {isSignUpOpen && (
              <div className="fixed top-0 left-0 w-full h-full bg-black bg-opacity-50 flex items-center justify-center z-50">
                <div
                  ref={signUpRef}
                  className="relative mx-auto w-full max-w-md overflow-hidden rounded-lg bg-dark_grey bg-opacity-90 backdrop-blur-md px-6 pb-8 pt-12 text-center sm:px-8"
                >
                  <button
